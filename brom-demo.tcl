#
# Project automation script for brom-demo
#
# Created for ISE version 14.7
#
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source brom-demo.tcl), then you can
...
set myProject "brom-demo"
set myScript "brom-demo.tcl"
...
proc add_source_files {} {
   ...
   xfile add "ipcore_dir/Clock/Clock.xco"
   xfile add "ipcore_dir/Counter30/Counter30.xco"
   xfile add "ipcore_dir/Rom/Rom.xco"
   xfile add "src/constraints/Top.ucf"
   xfile add "src/hdl/Top.vhd"
   puts ""
...
proc set_process_props {} {
   ...
   project set "Target UCF File Name" "C:/Users/IEUser/Developer/VHLD/brom-demo/Top.ucf" -process "Back-annotate Pin Locations"
   ...
   project set "Work Directory" "C:/Users/IEUser/Developer/VHLD/brom-demo/xst" -process "Synthesize - XST"
